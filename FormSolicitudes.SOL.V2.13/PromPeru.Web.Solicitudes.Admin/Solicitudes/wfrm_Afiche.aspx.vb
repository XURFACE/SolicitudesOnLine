        ...
        If Not IsPostBack Then
            ...
            If Not IsPostBack Then
                If Not IsNothing(Request.QueryString("id")) Then
                    ...
                    rutaRelativa = ConfigurationManager.AppSettings("rutaImagenCorto") & objBEAplicacionRO.oBEAPLICACION.strRUTA_IMAGEN
                    ...
                    hprlinkImgComplete.NavigateUrl = rutaRelativa
                End If
            End If
