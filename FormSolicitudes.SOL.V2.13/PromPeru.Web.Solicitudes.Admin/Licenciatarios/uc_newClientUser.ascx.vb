...
Public Class uc_newClientUser
    ...
    Public Property TipoControl As tipoControlUSR
        Set(ByVal value As tipoControlUSR)
            ...
            rfvPwd.Visible = value = tipoControlUSR.Ingresa
            rfvPwd0.Visible = value = tipoControlUSR.Ingresa

            imgCmp.Visible = value = tipoControlUSR.Ingresa
            trCapcha0.Visible = value = tipoControlUSR.Ingresa
            trCapcha1.Visible = value = tipoControlUSR.Ingresa
        ...
        If Not IsPostBack Then
            ...
            If TipoControl <> tipoControlUSR.Ingresa Then
                ...
                If objBC.oBECLIENT_USER.lngID <> 0 Then
                    ...
                    hdfCodVer.Value = objBC.oBECLIENT_USER.strCODVERIFICACION
                End If
            End If
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            objBCro.oBECLIENT_USER.lngID = hdfId.Value
            objBCro.LeerCLIENT_USER()
            Dim objBEuser As New BE.clsBE_CLIENT_USER
            If Not IsNothing(objBCro.oBECLIENT_USER) AndAlso objBCro.oBECLIENT_USER.lngID <> 0 Then
                ...
                objBEuser.strCODVERIFICACION = hdfCodVer.Value
                objBEuser.strLOGINUSR = txtLogin.Text
                Dim objbc As New BC.clsBC_CLIENT_USERTX
                objbc.LstCLIENT_USER.Add(objBEuser)
                objbc.ModificarCLIENT_USER()
            Else
                Throw New Exception("Error la intentar guardar, cierre el formulario e intente nuevamente")
            End If
