...
#Region "Clase Lectura" 
	...
	Public Class clsBC_AMBITOUSORO
        ...
        Public Sub LeerListaAMBITOUSO(ByVal idSol As Long)
            Try
                LstAMBITOUSO = oDALCAMBITOUSORO.LeerListaAMBITOUSOByIDSol(idsol)
            Catch ex As Exception
                Throw ex
            End Try
        End Sub
        ...
        Public Function LeerListaToDTAMBITOUSO(ByVal idsol As Long) As DataTable
            Try
                oDTAMBITOUSO = oDALCAMBITOUSORO.LeerListaToDTAMBITOUSO(idsol)
                Return oDTAMBITOUSO
            Catch ex As Exception
                Throw ex
            End Try
