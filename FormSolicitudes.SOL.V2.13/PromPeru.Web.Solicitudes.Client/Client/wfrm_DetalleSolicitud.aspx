<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/ClientMasterPage.Master"
    CodeBehind="wfrm_DetalleSolicitud.aspx.vb" Inherits="PromPeru.Web.Solicitudes.Client.wfrm_DetalleSolicitud" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function cargarPopupAdd() {
            ...
            var id = url.split('=')[1];
            if (id != null)
                $(this).modal({ width: 370, height: 300, src: "wfrm_ArchivoAplicacion.aspx?idsol=" + id }).open();
        }
        function cargarImage(id) {
            $(this).modal({ width: 370, height: 300, src: "wfrm_RecuperarImagen.aspx?id=" + id }).open();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table-content-form" style="width: 96%;">
        ...
        <tr>
            ...
            <td colspan="2">
                <h6>
                    <asp:Label ID="lblUSO" Style="float: left; font-size: 16px; font-family: 'Bree';" runat="server" Text="DATOS RELACIONADOS AL USO"></asp:Label></h6>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td class="style6" colspan="2">
                <div>
                    <asp:GridView ID="gViewDU" runat="server" AutoGenerateColumns="False" GridLines="None"
                        CssClass="mGrid" PagerStyle-CssClass="pgr" Width="550px" BorderColor="Red" BorderStyle="Dashed"
                        BorderWidth="1px">
                        <Columns>
        ...
        <tr id="trRefProds1" runat="server">
            ...
            <td class="style6" valign="top">
                <asp:Label ID="lblRotRefProd" Style="top: 0px; vertical-align: top;" runat="server"
                    CssClass="RotbigDetail" Text="Referencias de Marca:"></asp:Label>
            </td>
            <td>
        ...
        <tr id="trgrvEvento" runat="server">
            <td>
            </td>
            <td class="style6" colspan="2">
                <table style="border: 1px solid #CCC">
                    ...
                    <tr>
                        ...
                        <td class="line-tr">
                            ...
                            <div>
                                <asp:HyperLink ID="lnkreferencia" Target="_blank" runat="server"></asp:HyperLink>
                            </div>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            ...
            <td class="contenet-form">
                <h6>
                    ARCHIVOS ADICIONALES:</h6>
            </td>
            <td>
                <div class="buttom-conten">
                    <div class="buttom-center">
                        <asp:LinkButton ID="LBAddDocs" runat="server" href="javascript:cargarPopupAddDocuments()">&nbsp;Agregar Archivo</asp:LinkButton>
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="3">
                <div style="margin-left: 35px">
                    <asp:GridView ID="grvApl" runat="server" AutoGenerateColumns="False" CssClass="mGrid">
                        <Columns>
                            <asp:BoundField DataField="IDAPL" HeaderText="ID" Visible="False" />
                            <asp:TemplateField HeaderText="ARCHIVO">
                                <ItemTemplate>
                                    <asp:HyperLink Target="_blank" ID="lnkRF" class="EFile" runat="server" Text='<%# Bind("RUTA_IMAGEN") %>'
                                        NavigateUrl='<%# Bind("RUTA_IMAGEN") %>'></asp:HyperLink>
                                </ItemTemplate>
                            ...
                            <asp:BoundField DataField="STSAPLICACION" HeaderText="ESTADO">
                                <HeaderStyle Width="100px" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="OPCIONES">
                                <ItemTemplate>
                                    <div class="div-lickMostrar">
                                        <a href='javascript:cargarImage(<%#Eval("IDAPL")%>)'>Mostrar</a>
                                    </div>
                                    <div class="div-lickEliminar">
                                        <asp:LinkButton ID="LBDelete" runat="server" CausesValidation="False" CommandName="DeleteApp"
                                            CommandArgument='<%# Bind("IDAPL") %>' Text="Eliminar"></asp:LinkButton>
                                    </div>
                                </ItemTemplate>
    ...
    <div style="display: none">
        <asp:TextBox ID="THState" runat="server"></asp:TextBox>
    </div>
