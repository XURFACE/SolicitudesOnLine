<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrm_AddDocuments.aspx.vb" Inherits="PromPeru.Web.Solicitudes.Client.wfrm_AddDocuments" %>
    ...
    <table class="popup-form">
        ...
        <tr>
            ...
            <cc1:FileUploaderAJAX ID="FUAjaxApl" runat="server" CssClass="fileAjax" 
                    MaxFiles="1" text_Add="Adjuntar Documento" File_RenameIfAlreadyExists="true" Directory_CreateIfNotExists="true" text_Delete="Quitar"   text_Uploading="Subiendo.." />
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtAplDesc" ErrorMessage="*"></asp:RequiredFieldValidator>
            </td>
        </tr>
